...
const universitiesData: University[] = [
  {
    ...
    longDescription: 'The University of the Philippines Diliman is the flagship campus of the University of the Philippines System. Established in 1908, it has been at the forefront of higher education in the Philippines for over a century. Known for its rigorous academic programs, world-class research facilities, and distinguished alumni, UP Diliman continues to be the premier institution of higher learning in the country. The university offers a wide range of undergraduate and graduate programs across various disciplines, from the humanities and social sciences to engineering and the natural sciences.',
    ...
    galleryImages: [
      'https://images.pexels.com/photos/1595391/pexels-photo-1595391.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      'https://images.pexels.com/photos/207692/pexels-photo-207692.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      'https://images.pexels.com/photos/1454360/pexels-photo-1454360.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
      'https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop'
    ],
    ...
    facilities: ['Main Library', 'Research Laboratories', 'Sports Complex', 'Student Dormitories', 'Medical Center', 'Cultural Center', 'Computer Centers', 'Botanical Garden'],
    achievements: ['Top 1 University in Philippines', 'QS World University Rankings 2024', 'Research Excellence Award', 'ASEAN University Network Member'],
    admissionRequirements: ['UPCAT Examination', 'High School Diploma', 'Good Moral Character', 'Medical Certificate', 'Birth Certificate'],
    scholarships: ['Socialized Tuition System', 'Academic Scholarships', 'Athletic Scholarships', 'Cultural Scholarships', 'Need-based Grants'],
    studentLife: {
      clubs: 150,
      sports: 25,
      dormitories: true,
    ...
    academicCalendar: {
      semesterStart: 'August 2024',
      semesterEnd: 'May 2025',
  ...
  },
  {
    ...
    subjects: ['Engineering', 'Business', 'Computer Science', 'Architecture', 'Education', 'Liberal Arts', 'Technology', 'Accountancy'],
    ...
    address: 'A. Mabini Campus, Anonas Street, Santa Mesa, Manila',
...
export default function UniversityDetails() {
  ...
  const university = universitiesData.find(u => u.id === parseInt(id || '1'));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            <div className="lg:col-span-3">
              <img
                src={university.galleryImages[selectedImage]}
                alt={university.name}
              ...
              {university.galleryImages.map((image, index) => (
                <button
                  ...
                  className={`relative h-20 lg:h-24 rounded-lg overflow-hidden ${
                    selectedImage === index ? 'ring-2 ring-maroon-600' : ''
                  }`}
                >
                  <img
                    src={image}
        ...
        {activeTab === 'academics' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Campus Facilities</h3>
        ...
        {activeTab === 'admissions' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Tuition & Fees</h3>
              <div className="bg-white p-6 rounded-xl border border-gray-200">
            ...
            <div>
              ...
              <div className="bg-maroon-50 p-6 rounded-xl border border-maroon-200 mt-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between bg-white p-4 rounded-lg border border-gray-200">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    university.studentLife.dormitories 
                ...
                <div className="flex items-center justify-between bg-white p-4 rounded-lg border border-gray-200">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    university.studentLife.library 
                      ? 'bg-green-100 text-green-800' 
                      : 'bg-red-100 text-red-800'
                  }`}>
        ...
        {activeTab === 'contact' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              ...
              <div className="bg-maroon-50 p-6 rounded-xl border border-maroon-200 mt-6">
                <h3 className="text-lg font-bold text-maroon-900 mb-4">Get in Touch</h3>
                <p className="text-maroon-700 mb-4">
                  Have questions about admissions or programs? Contact the university directly.
                </p>
                <div className="flex gap-3">
                  <button className="flex-1 bg-maroon-600 text-white py-2 px-4 rounded-lg hover:bg-maroon-700 transition-colors">
                    Call Now
                  </button>
                  <button className="flex-1 border border-maroon-600 text-maroon-600 py-2 px-4 rounded-lg hover:bg-maroon-50 transition-colors">
                    Send Email
                  </button>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 mt-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Visit Campus</h3>
                <p className="text-gray-600 mb-4">
                  Schedule a campus tour to experience {university.name} firsthand.
                </p>
                <button className="w-full bg-maroon-600 text-white py-3 rounded-lg hover:bg-maroon-700 transition-colors font-semibold">
